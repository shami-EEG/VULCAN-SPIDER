...
mass_outfile = 'output/vulcan_mass_mix.txt' # the equilibrium output in "mass mixing ratio" 
col_mass_outfile = 'output/vulcan_col_mass.txt' # the column mass of each species in EQ at each verical level (mass/area)
